...
<link href="/css/bootstrap/ofzfcanvas.css" rel="stylesheet">
</head>
...
<main role="main" class="container">
    <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-primary rounded box-shadow">
        ...
        <div class="lh-100">
            <h6 class="mb-0 text-white lh-100">부서리스트</h6>
    ...
    <div class="my-3 p-3 bg-white rounded box-shadow">
        ...
        <div class="my-3 p-3 bg-white">
            <form>
                <select class="form-check-label" name="searchType">
                ...
                <table>
                    ...
                    <tr>
                        <td><input class="btn btn-outline-info" type="submit" value="검색">
                        </td>
                    </tr>
                </table>
            </form>
        ...
        <small class="d-block text-right mt-3">
            <a href="/dept/register" class="btn alert-danger">부서 등록</a>
            <a href="/dept/register" class="btn btn-primary">부서 등록</a>
        </small>
    </div>
